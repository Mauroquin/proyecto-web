    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.texto}>
          <div className={styles.imagenContainer} style={{ textAlign: "left" }}>
            ...
            <div style={{ textAlign: "left" }}>
              ...
              <p>
                Mariposa monarca: ciclo de vida, huevo, adulto, migración,
                hibernación, reproducción, desarrollo, plantas, hospederas.
              </p>
            </div>
          ...
          <div className={styles.imagenContainer}>
            ...
            <div style={{ textAlign: "left" }}>
              ...
              <p>
                Interdependencia, Amenazas, Jardines polinizadores,
                Restauración, Red ecológica, Equilibrio.
              </p>
            </div>
        ...
        <div className={styles.parrafoDerecha}>
          <p>
            Explora la vida de la mariposa monarca en nuestra Galería de Arte
          ...
          <div className={styles.imagenContainer}>
            ...
            <div style={{ textAlign: "left" }}>
              <h3>La Voz Humana</h3>
              <p>
                Conexión cultural, Social, Comunidades mexicanas, Mitos, Arte,
                Conservación humana, Tradiciones.
              </p>
            </div>
